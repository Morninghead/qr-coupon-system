...
async function renderCardToCanvas(employee, template, cardWidthMm, cardHeightMm) {
    ...
    // FIX 1: Expose JSDOM globals to the Node.js global scope
    ...
    // FIX 2: Create dummy (mock) functions for getComputedStyle and scrollTo
    // This prevents html2canvas from crashing when it can't find these browser-only functions.
...
// ... (ส่วนฟังก์ชัน generateCardHtml เหมือนเดิม ไม่ต้องแก้ไข)
